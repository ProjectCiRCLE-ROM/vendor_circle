...
custom_github_revision = "lineage-23.2"
custom_dependencies = "circle.dependencies"
org_manifest = "circling-devices"  # leave empty if org is provided in manifest
org_display = "CiRCLING-Devices"  # needed for displaying
