...
ALARM_PATH := vendor/circle/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/circle/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/circle/prebuilt/common/media/audio/ringtones
